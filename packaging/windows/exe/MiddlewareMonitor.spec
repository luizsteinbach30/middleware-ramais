...
hiddenimports = [
    ...
    "middleware_monitor.api.noc",
    "middleware_monitor.jobs.noc_agent",
    "middleware_monitor.domain.noc.estado",
    "middleware_monitor.domain.noc.cliente",
    ...
    "certifi",
    "middleware_monitor.domain.uscall.saude",
